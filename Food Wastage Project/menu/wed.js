...
const data = {
    breakfast: ["Dosa with Chutney", "Upma", "Cornflakes with Milk", "Tea / Coffee / Milk"],
    lunch: ["Rice", "Sambar", "Aloo Gobi Masala", "Chapati", "Beans Curry", "Curd", "Salad"],
    snacks: ["Pakoda", "Tea / Coffee"],
    dinner: ["Veg Fried Rice", "Chilli Paneer", "Roti", "Dal Makhani", "Pickle", "Gulab Jamun"]
...
const Wednesday = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Wednesday's Menu</Text>
