...
const data = {
    breakfast: ["Puri with Bhaji", "Idli", "Cornflakes with Milk", "Tea / Coffee / Milk"],
    lunch: ["Rice", "Dal Fry", "Mix Vegetable Curry", "Chapati", "Curd", "Salad"],
    snacks: ["Bhel Puri", "Tea / Coffee"],
    dinner: ["Tomato Rice", "Palak Paneer", "Roti", "Dal Tadka", "Pickle", "Ice Cream"]
...
const Friday = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Friday's Menu</Text>
