...
const data = {
    breakfast: ["Aloo Paratha with Curd", "Bread Butter & Jam", "Tea / Coffee / Milk"],
    lunch: ["Rice", "Kadhi Pakora", "Baingan Bharta", "Chapati", "Curd", "Salad"],
    snacks: ["French Fries", "Tea / Coffee"],
    dinner: ["Veg Pulao", "Malai Kofta", "Roti", "Dal Fry", "Pickle", "Rasgulla"]
...
const Sunday = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Sunday's Menu</Text>
